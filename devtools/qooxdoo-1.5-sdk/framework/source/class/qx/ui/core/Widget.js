  ...
  */
  ...
  members :
  {
    ...
    */
    ...
    {
      if (qx.core.Environment.get("eyeos.debug")) {
        var attributes = {
          "$$widget": this.toHashCode(),
          "data-qx-widget": this.toString().split('.').pop(),
          "data-qx-widget-element": 'container',
          "data-qx-appearance": this.getAppearance(),
          "data-qx-fullname": this.toString()
        };
      } else {
        var attributes = {
          "$$widget": this.toHashCode()
    ...
    __createContentElement : function()
    {
      ...
      if (qx.core.Environment.get("eyeos.debug")) {
        el.setAttributes({
          "data-qx-widget": this.toString().split('.').pop(),
          "data-qx-widget-element": 'content'
        })
      }
