...
if(!defined('ROUND_CUBE_DIR'))
	define('ROUND_CUBE_DIR', 'rmail');
if(!defined('ROUND_CUBE_TEMP_DIR'))
	define('ROUND_CUBE_TEMP_DIR', APPS_DIR . '/' . ROUND_CUBE_DIR . '/webmail/temp');
if(!defined('ROUND_CUBE_DOWN_DIR'))
	define('ROUND_CUBE_DOWN_DIR', APPS_DIR . '/' . ROUND_CUBE_DIR . '/webmail/downloads');
...
if(!defined('SESSION_HANDLER')) {
	define('SESSION_HANDLER', 'SessionFile');
}
?>