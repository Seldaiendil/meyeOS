    ...
    members: {
        ...
        drawGUI: function() {
			...
			for(var i = 0; i < this.__files.length; i++) {
				...
				this.thubnail[i].setSource('index.php?checknum='+this.getChecknum()+'&message=__FileSystem_getScaledImage&params[path]='+encodeURIComponent(this.__files[i])+'&params[maxHeight]=140&params[maxWidth]=140');
				...
				this.thubnail[i].addListener('click', function(e) {
					...
					this.mainImage.setSource('index.php?checknum='+this.getChecknum()+'&message=__FileSystem_readFile&params='+encodeURIComponent(this.__files[this.current]));
				}, this);
			...
			this.mainImage.setSource('index.php?checknum='+this.getChecknum()+'&message=__FileSystem_readFile&params[path]='+encodeURIComponent(this.__files[0]));
