...
qx.Class.define('eyeos.application.Calendar', {
	...
	members: {
		...
		_buildMenuBar: function() {
			...
			this.__menuBar.setIconsPath('eyeos/extern/images/calendar/');
		...
		_buildToolBar: function() {
			...
			this.__toolBar.setIconsPath('eyeos/extern/images/calendar/');
		 ...
		 */
		drawGUI: function() {
			this.__window = new eyeos.ui.Window(this, tr('Calendar'), 'eyeos/extern/images/16x16/apps/office-calendar.png').set({
