...
qx.Class.define('eyeos.calendar.dialogs.Settings', {
	...
	construct: function (controller) {
		...
		arguments.callee.base.call(this, 'Settings', 'eyeos/extern/images/16x16/actions/configure.png');
	...
	members: {
		...
		__getCalendarsTab: function() {
			var page = new qx.ui.tabview.Page('Calendars', 'eyeos/extern/images/16x16/actions/view-pim-calendar.png');
		...
		__getGeneralTab: function() {
			var page = new qx.ui.tabview.Page('General', 'eyeos/extern/images/16x16/actions/configure.png');
			var layout = new qx.ui.layout.Grid();
			page.setLayout(layout);
			layout.setColumnFlex(0, 1);
