...
qx.Class.define('eyeos.calendar.dialogs.EditEvent', {
	...
	construct: function (eventView) {
		...
		arguments.callee.base.call(this, title, 'eyeos/extern/images/16x16/actions/appointment-new.png');
	...
	members: {
        ...
        __createDeleteMenu: function(menyType) {
              ...
              if (menyType == 'group'){
                      ...
                      var deleteThisOnly = new qx.ui.menu.Button(tr('Delete only this event'), 'eyeos/extern/images/16x16/actions/edit-delete.png')
                      ...
                      deleteThisOnly.addListener('execute', function(e) {
                       ...
                       menu.add(new qx.ui.menu.Separator());
                      var deleteAll = new qx.ui.menu.Button(tr('Delete all events of this series'), 'eyeos/extern/images/calendar/delete_all.png')
                      menu.add(deleteAll);
        ...
        __createEditMenu: function(menyType) {
              ...
              if (menyType == 'group') {
                      menu.add(new qx.ui.menu.Separator());
                      var deleteThisOnly = new qx.ui.menu.Button(tr('Edit only this event'), 'eyeos/extern/images/calendar/edit_event.png')
                      menu.add(deleteThisOnly);
                      deleteThisOnly.addListener('execute', function(e) {
                      ...
                      menu.add(new qx.ui.menu.Separator());
                      var deleteAll = new qx.ui.menu.Button(tr('Edit all events of this series'), 'eyeos/extern/images/calendar/edit_all.png')
                      menu.add(deleteAll);
                      deleteAll.addListener('execute', function(e) {
