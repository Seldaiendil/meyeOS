...
qx.Class.define('eyeos.calendar.view.Event', {
	...
	_applyMode: function(value, old) {
        ...
        __createDeleteMenu: function(menyType) {
			...
			var menuLabel = new qx.ui.menu.Button(this.__eventModel.getSubject(), 'eyeos/extern/images/calendar/delete_event.png').set({
				enabled: false
			});
				if (menyType == 'group'){
							menu.add(menuLabel);
							...
							var deleteItem = new qx.ui.menu.Button(tr('Delete'), 'eyeos/extern/images/16x16/actions/edit-delete.png');
							menu.add(deleteItem);
