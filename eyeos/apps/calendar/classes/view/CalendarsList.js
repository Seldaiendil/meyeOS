...
qx.Class.define('eyeos.calendar.view.MyCalendarsList', {
	...
	members: {
		...
		__createMenu: function(calendar) {
			...
			var calendarLabel = new qx.ui.menu.Button(calendar.getName(), 'eyeos/extern/images/16x16/actions/view-pim-calendar.png').set({
				enabled: false
			});
			menu.add(calendarLabel);
			menu.add(new qx.ui.menu.Separator());
			menu.add(new qx.ui.menu.Button(tr('Add event'), 'eyeos/extern/images/16x16/actions/appointment-new.png'));
			menu.add(new qx.ui.menu.Button(tr('Settings'), 'eyeos/extern/images/16x16/actions/configure.png'));
			var deleteButton= new qx.ui.menu.Button(tr('Delete Calendar'), 'eyeos/extern/images/16x16/actions/edit-delete.png');
...
qx.Class.define('eyeos.calendar.view.CalendarsList.CheckBox', {
	...
	members: {
		...
		_createChildControlImpl : function(id) {
			...
			switch(id) {
				case 'menu-button':
					control = new qx.ui.basic.Image('eyeos/extern/images/calendar/tiny_arrow_white.png').set({
						width: 13,
						height: 13,
						maxHeight: 13,
		...
		_onChangeColor: function(value, old) {
			...
			image.setSource('eyeos/extern/images/calendar/' + imageSrc);
		},
