...
qx.Class.define('eyeos.calendar.view.RibbonCalendar', {
	...
	members: {
		...
		_init: function() {
			...
			var arrowLeft = new qx.ui.basic.Atom(null, 'eyeos/extern/images/arrowLeft.png').set({
				alignY: 'middle',
				center: true,
				cursor: 'pointer',
				width: 14
			...
			var arrowRight = new qx.ui.basic.Atom(null, 'eyeos/extern/images/arrowRight.png').set({
				alignY: 'middle',
				center: true,
				cursor: 'pointer',
				width: 14
