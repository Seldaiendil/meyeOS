...
qx.Class.define('eyeos.calendar.view.ViewModeSelector', {
	...
	members: {
		...
		_init: function() {
			...
			// cis team
			this._goPreviousButton = new qx.ui.basic.Image('eyeos/extern/images/calendar/go-previous.png').set({
						marginTop:5,																						
						width: 13,
						height: 13,
						scale: true,
 ...
 */
			this._goNextButton = new qx.ui.basic.Image('eyeos/extern/images/calendar/go-next.png').set({
						marginTop:5,																						
						width: 13,
						height: 13,
						scale: true,
