...
qx.Class.define('eyeos.application.notepad', {
    ...
    members: {
	    ...
	    _drawGUI: function() {
	    	this._window = new eyeos.ui.Window(this, 'notepad Text Editor', 'eyeos/extern//images/16x16/apps/accessories-text-editor.png').set({
	    	...
	    	var newButton = new qx.ui.toolbar.Button(tr('New'), 'eyeos/extern/images/16x16/actions/document-new.png');
	    	newButton.addListener('execute', this._onNew, this);
	    	toolbarBox.add(newButton);
	    	
	    	var openButton = new qx.ui.toolbar.Button(tr('Open'), 'eyeos/extern/images/16x16/actions/document-open.png');
	    	openButton.addListener('execute', this._onOpen, this);
	    	toolbarBox.add(openButton);
	    	
	    	var closeButton = new qx.ui.toolbar.Button(tr('Close'), 'eyeos/extern/images/16x16/actions/document-close.png');
	    	closeButton.addListener('execute', this._onClose, this);
	    	toolbarBox.add(closeButton);
	    	
	    	var saveButton = new qx.ui.toolbar.Button(tr('Save'), 'eyeos/extern/images/16x16/actions/document-save.png');
	    	saveButton.addListener('execute', this._onSave, this);
	    	toolbarBox.add(saveButton);
	    	
	    	var saveAsButton = new qx.ui.toolbar.Button(tr('Save As'), 'eyeos/extern/images/16x16/actions/document-save-as.png');
...
qx.Class.define('eyeos.notepad.Page', {
	...
	construct: function() {
		...
		arguments.callee.base.call(this, this._filename, 'eyeos/extern/images/16x16/mimetypes/text-plain.png');
		...
		myButton.getChildControl('close-button').setIcon('eyeos/extern/images/Close.png');
