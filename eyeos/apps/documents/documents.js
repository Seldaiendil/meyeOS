...
function documents_application(checknum, pid, args) {
	...
	application.setIconsPath('eyeos/extern/images/documents/');
	...
	members: {
        ...
        */
		initApplication: function(username, image) {
			...
			this.setWindow(new eyeos.ui.Window(this, 'Documents', 'eyeos/extern//images/16x16/apps/okteta.png', true).set({
				contentPadding: 0,
...
//							ed.selection.getNode().style.fontSize = '12px';
							...
							(new qx.io.ScriptLoader).load('eyeos/extern/js/tinymce/jscripts/tiny_mce/plugins/table/js/table.js');
...
//				console.log('changing privileges...');
		...
		createEmptySocialBar: function() {
			if(this.getFilePath()) {
				...
				var imagePath = 'eyeos/extern/images/64x64/actions/document-preview.gif';
