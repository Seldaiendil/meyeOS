...
//			});
		...
		tableContentAlignmentWindow: function(object) {
			...
			var leftButton = new qx.ui.toolbar.RadioButton('left', 'eyeos/extern/images/documents/Content-align-1.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var centerButton = new qx.ui.toolbar.RadioButton('center', 'eyeos/extern/images/documents/Content-align-2.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var rightButton = new qx.ui.toolbar.RadioButton('right', 'eyeos/extern/images/documents/Content-align-3.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var topButton = new qx.ui.toolbar.RadioButton('top', 'eyeos/extern/images/documents/Content-align-4.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var middleButton = new qx.ui.toolbar.RadioButton('middle', 'eyeos/extern/images/documents/Content-align-5.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var bottomButton = new qx.ui.toolbar.RadioButton('bottom', 'eyeos/extern/images/documents/Content-align-6.png').set({
				show: 'icon',
				margin: 10
			});
		...
		formatBulletsAndNumberingWindow: function(object, e) {
			...
			var bulletsNoneButton = new qx.ui.toolbar.RadioButton(null, 'eyeos/extern/images/documents/none.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var bulletsCircleFillButton = new qx.ui.toolbar.RadioButton(null, 'eyeos/extern/images/documents/Bullets-1.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var bulletsCircleEmptyButton = new qx.ui.toolbar.RadioButton(null, 'eyeos/extern/images/documents/Bullets-2.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var bulletsSquareFillButton = new qx.ui.toolbar.RadioButton(null, 'eyeos/extern/images/documents/Bullets-3.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var bulletsSquareEmptyButton = new qx.ui.toolbar.RadioButton(null, 'eyeos/extern/images/documents/Bullets-4.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var bulletsDiamantFillButton = new qx.ui.toolbar.RadioButton(null, 'eyeos/extern/images/documents/Bullets-5.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var bulletsDiamantEmptyButton = new qx.ui.toolbar.RadioButton(null, 'eyeos/extern/images/documents/Bullets-6.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var mumberingNoneButton = new qx.ui.toolbar.RadioButton(null, 'eyeos/extern/images/documents/none.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var numbering123DotsButton = new qx.ui.toolbar.RadioButton(null, 'eyeos/extern/images/documents/Numbering-1.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var numbering123ClassicButton = new qx.ui.toolbar.RadioButton(null, 'eyeos/extern/images/documents/Numbering-2.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var numberingABCDotsButton = new qx.ui.toolbar.RadioButton(null, 'eyeos/extern/images/documents/Numbering-3.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var numberingABCClassicButton = new qx.ui.toolbar.RadioButton(null, 'eyeos/extern/images/documents/Numbering-4.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var numberingAbcDotsButton = new qx.ui.toolbar.RadioButton(null, 'eyeos/extern/images/documents/Numbering-5.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var numberingAbcClassicButton = new qx.ui.toolbar.RadioButton(null, 'eyeos/extern/images/documents/Numbering-6.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var numberingRomanUpcaseDotsButton = new qx.ui.toolbar.RadioButton(null, 'eyeos/extern/images/documents/Numbering-7.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var numberingRomanUpcaseClassicButton = new qx.ui.toolbar.RadioButton(null, 'eyeos/extern/images/documents/Numbering-8.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var numberingRomanDowncaseDotsButton = new qx.ui.toolbar.RadioButton(null, 'eyeos/extern/images/documents/Numbering-9.png').set({
				show: 'icon',
				margin: 10
			});
			...
			var numberingRomanDowncaseClassicButton = new qx.ui.toolbar.RadioButton(null, 'eyeos/extern/images/documents/Numbering-10.png').set({
				show: 'icon',
				margin: 10
			});
	...
	formatDocumentSettingsWindow: function(object, e) {
			...
			var portraitImage = new qx.ui.basic.Image('eyeos/extern/images/documents/page-orientation-portrt-32.png');
			orientationBox.add(portraitImage, {
				top: 20,
				left: 100
			});

			var landscapeImage = new qx.ui.basic.Image('eyeos/extern/images/documents/page-orientation-landscp-32.png');
			landscapeImage.hide();
			...
			var bold = new qx.ui.toolbar.RadioButton(null, 'eyeos/extern/images/documents/format-text-bold.png');
			watermarkGroupBox.add(bold, {
				top: 30,
				left: 0
			});
			var italic = new qx.ui.toolbar.RadioButton(null, 'eyeos/extern/images/documents/format-text-italic.png');
