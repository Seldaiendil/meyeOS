	...
	members: {
		...
		_applyPanelStyle: function () {
			...
			var decoratorTaskBar = new qx.ui.decoration.Background().set({
				backgroundImage: 'eyeos/extern/images/bgTaskBar.png'
		...
		_createCascadeWindowsButton: function () {
			this._cascadeWindowsButton = new qx.ui.form.ToggleButton('', 'eyeos/extern/images/CascadeWindows.png');
		...
		_createShowDesktopButton: function () {
			this._showDesktopButton = new qx.ui.form.ToggleButton('', 'eyeos/extern/images/ShowDesktop.png');
		...
		_createClock : function() {
			...
			// ----- events
            var buttonEvents = new qx.ui.menu.Button(tr('Events'), 'eyeos/extern/images/22x22/actions/irc-voice.png');
			...
			// ----- About eyeOS
            var buttonAbout = new qx.ui.menu.Button(tr('About eyeOS'), 'eyeos/extern/images/22x22/actions/help-about.png');
			...
			// ----- Administration
            var buttonAdministration = new qx.ui.menu.Button(tr('Administration'), 'eyeos/extern/images/22x22/actions/system-run.png');
			...
			// ----- preferences
            var buttonPreferences = new qx.ui.menu.Button(tr('Preferences'), 'eyeos/extern/images/22x22/actions/configure.png');
			...
			// ----- sign out
            var buttonSignOut = new qx.ui.menu.Button(tr('Sign out'), 'eyeos/extern/images/22x22/actions/dialog-close.png');
