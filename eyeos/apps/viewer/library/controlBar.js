...
function createProgressBarCursor (father, progressBarControlFlag) {
	...
	progressBarCursor.src = 'eyeos/extern/images/viewer/circle.png';
	...
	progressBarCursor.onmouseover = function (){
		this.setAttribute('src', 'eyeos/extern/images/viewer/circle_x.png');
	}

	progressBarCursor.onmouseout = function (){
		this.setAttribute('src', 'eyeos/extern/images/viewer/circle.png');
	}
}
/*
 * -----------------------------------------------------------------------------
...
function createImportToDocuments (father, pid, checknum, myWindow) {
	...
	ImportToDocuments.src = 'eyeos/extern/images/viewer/convert-btn1.png';
	...
	ImportToDocuments.onmouseover = function (){
		this.setAttribute('src', 'eyeos/extern/images/viewer/convert-btn.png');
	}

	ImportToDocuments.onmouseout = function (){
		this.setAttribute('src', 'eyeos/extern/images/viewer/convert-btn1.png');
	}
...
function createVolumeLeftIcon (father) {
	...
	volumeLeftIcon.src = 'eyeos/extern/images/viewer/vol1.png';
...
function createVolumeRightIcon (father) {
	...
	volumeRighticon.src = 'eyeos/extern/images/viewer/vol2.png';
...
function createVolumeBarCursor (father, pid) {
	...
	volumeBarCursor.src = 'eyeos/extern/images/viewer/circle.png';
...
function createPreviousElementIcon (father, pid, plist, checknum) {
	...
	previousElementIcon.src = 'eyeos/extern/images/viewer/previous.png';
	...
	previousElementIcon.onmouseover = function (){
		this.setAttribute('src', 'eyeos/extern/images/viewer/previous_x.png');
	}

	previousElementIcon.onmouseout = function (){
		this.setAttribute('src', 'eyeos/extern/images/viewer/previous.png');
	}
}
...
function createNextElementIcon (father, pid, plist, checknum) {
	...
	nextElementIcon.src = 'eyeos/extern/images/viewer/next.png';
	...
	nextElementIcon.onmouseover = function (){
		this.setAttribute('src', 'eyeos/extern/images/viewer/next_x.png');
	}

	nextElementIcon.onmouseout = function (){
		this.setAttribute('src', 'eyeos/extern/images/viewer/next.png');
	}
}
...
function CreatePlayPauseIcon (father, pid) {
	...
	playPauseIcon.src = 'eyeos/extern/images/viewer/pause.png';
	...
	playPauseIcon.onclick = function (){
		if ($f(pid + '_viewer').isPlaying()) {
			$f(pid + '_viewer').pause();
			this.setAttribute('src', 'eyeos/extern/images/viewer/play_x.png');
		} else {
			$f(pid + '_viewer').play();
			this.setAttribute('src', 'eyeos/extern/images/viewer/pause_x.png');
		}

	}

	playPauseIcon.onmouseover = function (){
		if (this.getAttribute('src') == 'eyeos/extern/images/viewer/play.png') {
			this.setAttribute('src', 'eyeos/extern/images/viewer/play_x.png');
		} else {
			this.setAttribute('src', 'eyeos/extern/images/viewer/pause_x.png');
		}
	...
	playPauseIcon.onmouseout = function (){
		if (this.getAttribute('src') == 'eyeos/extern/images/viewer/play_x.png') {
			this.setAttribute('src', 'eyeos/extern/images/viewer/play.png');
		} else {
			this.setAttribute('src', 'eyeos/extern/images/viewer/pause.png');
		}
	}
}