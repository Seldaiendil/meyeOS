...
//		$response->getHeaders()->append('X-Pad: avoid browser bug');
	 ...
	 *		[format=> string]			Format of the output file, if the format its not implemented in mediaConverter throw new EyeNotImplementedException
	 * )
	 */
