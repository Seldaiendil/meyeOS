	...
	members: {
        ...
        getFileMenu: function() {
            var menu = [
                    {
                            label: tr('Open'),
                            image: 'eyeos/extern/images/16x16/actions/document-open.png',
                            id: 'openFile()'
                    }, {
                            label: tr('Rename'),
                            image: 'eyeos/extern/images/16x16/actions/edit-rename.png',
                            id: 'editFile()'
                    }, {
                            label: tr('Separator'),
                            id: 'separator'
                            ...
                            label: tr('Delete'),
                            image: 'eyeos/extern/images/16x16/actions/edit-delete.png',
                            id: 'deleteFile()'
                    }, {
                            label: tr('Download'),
                            image: 'eyeos/extern/images/16x16/actions/edit-paste.png',
                            id: 'downloadFile()'
                    }, {
                            label: tr('Share by URL'),
                            image: 'eyeos/extern/images/16x16/categories/applications-internet.png',
                            id: 'shareURLFile()'
                    }
            ];
		...
		getDesktopContextMenu : function() {
			var menu = 	[
			{
				...
				image: 'eyeos/extern/images/16x16/actions/window-new.png',
				id: 'uploadFile()'
			}, {
				label: tr('Separator'),
				id: 'separator'
				...
				label: tr('New folder'),
				image: 'eyeos/extern/images/16x16/places/folder.png',
				id: 'newFolder()'
			}, {
				label: tr('New simple document'),
				image: 'eyeos/extern/images/16x16/mimetypes/text-x-generic.png',
				id: 'newFile(\'txt\')'
			}, {
				label: tr('New document'),
				image: 'eyeos/extern/images/16x16/mimetypes/application-msword.png',
				id: 'newFile(\'edoc\')'
			}, {
				label: tr('New link'),
				image: 'eyeos/extern/images/16x16/mimetypes/application-x-mswinurl.png',
				id: 'newLink()'
			}, {
				label: tr('Separator'),
				id: 'separator'
				...
				label: tr('Settings'),
				image: 'eyeos/extern/images/16x16/actions/configure.png',
				id: 'openSettings()'
			}
			];
		...
		createDesktopWidgetAlone: function(checknum, files) {
			...
			var widget = new eyeos.dashboard.Widget(tr('Desktop'), 'files', 'files', true, checknum).set({
				icon: 'eyeos/extern//images/16x16/apps/system-file-manager.png'
			});
		...
		createInnerContent: function (widgetContainer, file, alone) {
			...
			if (file.type == 'folder') {
				...
				image = 'eyeos/extern/images/48x48/mimetypes/application-pdf.png';
			}else {
