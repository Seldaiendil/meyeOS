        ...
        createWidget: function() {
            ...
            var id = this.getId();
             ...
             var widget = new eyeos.dashboard.Widget(tr('Events'), id, '', false, checknum).set({
                icon: 'eyeos/extern//images/events/activity_16x16.png'
            });
            ...
            function createItem(result, num) {
                ...
                var path = 'eyeos/extern/images/events/activ_base-12x12.png';
                if (type == 'Files') {
                    path = 'eyeos/extern/images/events/activ_files-12x12.png'
                }
                else if (type == 'Dashboard') {
                    path = 'eyeos/extern/images/events/activ_dashboard-12x12.png'
                }
                else if (type == 'Applications') {
                    path = 'eyeos/extern/images/events/activ_appli-12x12.png'
                }
                else if (type == 'People') {
                    path = 'eyeos/extern/images/events/activ_people-12x12.png'
                }
                else if (type == 'Groups') {
                    path = 'eyeos/extern/images/events/activ_groups-12x12.png'
                }
                ...
                var deleteIcon = new qx.ui.basic.Image('eyeos/extern/images/clear.png').set({
                    alignY : 'middle',
                    alignX : 'right',
                    paddingLeft : 3,
                    paddingRight : 0,
