                ...
                if (meta['eyeos.user.desktop.wallpaperMode'] == undefined) {
                    ...
                    if (meta['eyeos.user.desktop.wallpaperMode'] == 'color') {
                        ...
                        if(meta['eyeos.user.desktop.wallpaper']) {
                            if (splitted[0] == 'sys:') {
                                this._dashImage.setSource('eyeos/extern/images/wallpapers/' + splitted[splitted.length - 2] + '/' + splitted[splitted.length - 1]);
                            } else {
                            ...
                            this._dashImage.setSource('eyeos/extern/images/wallpapers/nature/default.jpg');
                        }

                    }
                }

				if(this._dashImage.getSource() == 'eyeos/extern/images/wallpapers/nature/default.jpg') {
