...
function desktop_application(checknum, pid, args) {
	var applicationName = tr('Desktop');
	...
	buttonLayout.click(function () {
		eyeosmobile.openErrorDialog(tr('Closing Session'));
	...
	function createPeopleApplication (desktopApp) {
		var peopleParam = {
			image: 'eyeos/extern//images/128x128/apps/system-users.png',
	...
	function createWorkgroupApplication (desktopApp) {
		var peopleParam = {
			image: 'eyeos/extern//images/128x128/places/network-workgroup.png',
