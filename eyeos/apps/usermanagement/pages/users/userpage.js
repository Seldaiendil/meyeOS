...
qx.Class.define('eyeos.application.usermanagement.userpage', {
	...
	members: {
		...
		_createUserCommandButtonBox: function () {
			...
			var createUserButton = new qx.ui.form.Button(tr('Create'), 'eyeos/extern/images/16x16/actions/list-add.png');
			...
			var deleteUserButton = new qx.ui.form.Button(tr('Delete'), 'eyeos/extern/images/16x16/actions/edit-delete.png');
