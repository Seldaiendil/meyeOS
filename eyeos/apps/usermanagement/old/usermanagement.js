...
qx.Class.define('eyeos.application.UserManagement', {
	...
	members: {
		...
		drawGUI: function() {
			...
			var addButton = new qx.ui.basic.Image("eyeos/extern/images/usermanagement/mes.png");
			...
			var removeButton = new qx.ui.basic.Image("eyeos/extern/images/usermanagement/menys.png");
			removeButton.set({
				marginLeft: 5
			});
...
qx.Class.define('eyeos.usermanagement.panels.Panell', {
	...
	members: {
		...
		dibuixaTabCompta: function (page){
			...
			var ifill = new qx.ui.basic.Image("eyeos/extern/images/usermanagement/linia.png");
			ifill.setScale(true);
			ifill.set({
				marginTop:20,
				height:2
			...
			var infoImage = new qx.ui.basic.Image('eyeos/extern/images/16x16/status/dialog-information.png');
