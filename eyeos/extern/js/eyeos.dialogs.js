			...
			if (this._iconPath == null) {
				switch (this._messageType) {
					case this.self(arguments).ERROR_MESSAGE:
						this._iconPath = 'eyeos/extern/images/48x48/status/dialog-error.png';
						break;
					
					case this.self(arguments).INFORMATION_MESSAGE:
						this._iconPath = 'eyeos/extern/images/48x48/status/dialog-information.png';
						break;

					case this.self(arguments).WARNING_MESSAGE:
						this._iconPath = 'eyeos/extern/images/48x48/status/dialog-warning.png';
						break;
					
					case this.self(arguments).QUESTION_MESSAGE:
						this._iconPath = 'eyeos/extern/images/48x48/categories/system-help.png';
						break;
