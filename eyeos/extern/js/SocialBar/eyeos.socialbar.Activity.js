...
qx.Class.define('eyeos.socialbar.Activity', {
	...
	members: {
		...
		_createRevisionLayout: function () {
			...
			var revisionIcon = new qx.ui.basic.Image('eyeos/extern/images/back.png').set({
				alignX: 'right'
			});
		...
		_createIcon: function () {
			...
			switch (this.getType()) {
				case 'Modification':
					imageSrc = 'eyeos/extern/images/modified.png';
					break;
				case 'Note':
					imageSrc = 'eyeos/extern/images/note.png';
					break;
				case 'StartSharing':
					imageSrc = 'eyeos/extern/images/shared_on.png';
					break;
				case 'StopSharing':
					imageSrc = 'eyeos/extern/images/shared_off.png';
					break;
				case 'Others':
					imageSrc = this.getActivity().getIcon();
					break;
				case 'Created':
					imageSrc = 'eyeos/extern/images/new.png';
					break;
			}
