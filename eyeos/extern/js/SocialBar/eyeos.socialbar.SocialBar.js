...
qx.Class.define('eyeos.socialbar.SocialBar', {
	...
	members: {
		...
		createDefaultTabs: function () {
			this.removeAllTabs();
			this.addTab('Info', 'eyeos/extern/images/dialog-information.png', this.getBackgroundColor());
			this.addTab('Share', 'eyeos/extern/images/share.png', this.getBackgroundColor());
			this.addTab('Activity', 'eyeos/extern/images/document-open-recent.png', this.getBackgroundColor());
