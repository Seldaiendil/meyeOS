...
qx.Class.define('eyeos.socialbar.TagBox', {
	...
	members: {
		...
		_buildThirdLayoutBox: function () {
			...
			for (var i = 0; i < ids.length; ++i){
				...
				menuButton.addListener('execute',  function(e) {
					if (this.getSelected()) {
						...
						this._applyIcon('eyeos/extern/images/tick.png');
			...
			var tagMenuButton = new qx.ui.form.MenuButton(tr('Add Tag'), 'eyeos/extern/images/arrowPeople.png', tagMenu);
		...
		_isPresentTagOnRelation: function(id) {
			...
			for(var i = 0; i < relationIds.length; ++i){
				if (relationIds[i] == id) {
					return 'eyeos/extern/images/tick.png';
				}
			}
			return null;
		},
