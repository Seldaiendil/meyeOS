...
qx.Class.define('eyeos.ui.dashboard.WidgetView', {
	...
	members: {
		...
		_createTitleBarMenu: function() {
			...
			var titleBarMenuSettings = new qx.ui.menu.Button('Settings', 'eyeos/extern//images/16x16/actions/configure.png');
			this._applyTitleBarMenuDecoration(titleBarMenuSettings);
			this._titleBarMenu.add(titleBarMenuSettings);

			var titleBarMenuFullApp = new qx.ui.menu.Button('Open full app', 'eyeos/extern//images/16x16/actions/window-duplicate.png');
			this._applyTitleBarMenuDecoration(titleBarMenuFullApp);
			this._titleBarMenu.add(titleBarMenuFullApp);

			var titleBarMenuBackground = new qx.ui.menu.Button('Background', 'eyeos/extern//images/16x16/actions/games-config-background.png');
		...
		_createTitleBarButtons: function() {
			...
			var titleBarMenuButton = new qx.ui.form.MenuButton(null, 'eyeos/extern/images/Arrow50.png', this._titleBarMenu);
			...
			var titleBarMinimizeButton = new qx.ui.form.Button(null, 'eyeos/extern/images/Min50.png');
			...
			var titleBarCloseButton = new qx.ui.form.Button(null, 'eyeos/extern/images/Close50.png');
		...
		addListeners: function() {
			...
			titleBarMenuButton.addListener('mouseover', function () {
				if (!this._titleBarMenu.isVisible()) {
					titleBarMenuButton.setIcon('eyeos/extern/images/Arrow.png');
				}
			}, this);

			titleBarMenuButton.addListener('mouseout', function () {
				if (!this._titleBarMenu.isVisible()) {
					titleBarMenuButton.setIcon('eyeos/extern/images/Arrow50.png');
				}
			}, this);

			titleBarMenuButton.addListener('click', function () {
				titleBarMenuButton.setIcon('eyeos/extern/images/ArrowPush.png');
			}, this);
			...
			titleBarMinimizeButton.addListener('mouseover', function (e) {
				if (self._isMinimized) {
					this.setIcon('eyeos/extern/images/Max.png');
				} else {
					this.setIcon('eyeos/extern/images/Min.png');
				}
			});

			titleBarMinimizeButton.addListener('mouseout', function (e) {
				if (self._isMinimized) {
					this.setIcon('eyeos/extern/images/Max50.png');
				} else {
					this.setIcon('eyeos/extern/images/Min50.png');
				}
			});
			...
			titleBarCloseButton.addListener('mouseover', function () {
				this.setIcon('eyeos/extern/images/Close.png');
			});

			titleBarCloseButton.addListener('mouseout', function () {
				this.setIcon('eyeos/extern/images/Close50.png');
			});
...
//				}
		...
		_applyMinimized: function() {
			...
			if (this.getMinimized()) {
				titleBarMinimizeButton.setIcon('eyeos/extern/images/Min.png');
				this.restore();
			} else {
				titleBarMinimizeButton.setIcon('eyeos/extern/images/Max.png');
				this.minimize();
			}
		},
