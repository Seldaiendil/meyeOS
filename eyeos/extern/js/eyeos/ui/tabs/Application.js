...
//		}
	...
	members: {
		_imageStarFull: 'eyeos/extern/images/rate_on.png',
		_imageStarEmpty: 'eyeos/extern/images/rate_off.png',
		_imagePlus: 'eyeos/extern/images/new.png',
		_imageAdded: 'eyeos/extern/images/22x22/actions/dialog-ok-apply.png',
		...
		_updateLayoutAdded: function () {
			 ...
			 */
			this.cleanMenu();	
			var removeApp = new qx.ui.menu.Button('Remove Application', 'eyeos/extern//images/16x16/actions/edit-delete.png').set({
				'backgroundColor': '#ffffff'
			});
			
			var toggleFavorite = new qx.ui.menu.Button('Add/Remove Favorite', 'eyeos/extern//images/rate_on.png').set({
				'backgroundColor': '#ffffff'
			});

			var createDesktopIcon = new qx.ui.menu.Button('Create Desktop Shortcut', 'eyeos/extern//images/new.png').set({
				'backgroundColor': '#ffffff'
			});
