 ...
 * item.setImage('eyeos/extern/images/48x48/categories/applications-toys.png');
 */
...
qx.Class.define('eyeos.ui.tabs.Item', {
	...
	members: {
		...
		_buildGui: function () {
			...
			var menuButton = new qx.ui.basic.Atom(null, 'eyeos/extern/images/arrowPeople.png').set({
				decorator: null,
				paddingLeft: 4,
				cursor: 'pointer'
			});
