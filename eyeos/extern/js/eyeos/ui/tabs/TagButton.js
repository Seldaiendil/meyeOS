	...
	members: {
		...
		_buildLayout: function (caption/*, numItems*/) {
			...
			if (this._id > 0 && (!this._associatedPage.getLabel() == 'Groups')){
				...
				this._commandsButton = new qx.ui.form.MenuButton('', 'eyeos/extern/images/arrowPeople.png', commandsMenu).set({
					width: 15,
					maxWidth: 15,
					minWidth: 15,
					height: 15,
			...
			var buttons = new qx.ui.form.MenuButton(null, 'eyeos/extern/images/Arrow.png', buttonsMenu).set({
				width: 16,
				height: 16,
				paddingLeft: -4,
				paddingRight: -4,
			...
			var buttonEdit = new qx.ui.menu.Button('Edit', 'eyeos/extern/images/16x16/actions/document-edit.png').set({
				alignX: 'center',
				alignY: 'middle',
				width: 16
			});
			...
			var buttonDelete = new qx.ui.menu.Button('Delete', 'eyeos/extern/images/16x16/actions/edit-delete.png').set({
				alignX: 'center',
				alignY: 'middle',
				width: 16
			});
			...
			var buttonSave = new qx.ui.menu.Button('Save', 'eyeos/extern/images/16x16/actions/document-save.png').set({
				alignX: 'center',
				alignY: 'middle',
				width: 16
			});
			...
			var buttonCancel = new qx.ui.menu.Button('Cancel', 'eyeos/extern/images/16x16/actions/dialog-cancel.png').set({
				alignX: 'center',
				alignY: 'middle',
				width: 16
			});
