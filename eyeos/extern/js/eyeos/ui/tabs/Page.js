	...
	members: {
		...
		_createContextButtons: function (firstAction, secondAction) {
			...
			firstButton.set({
				...
				icon: 'eyeos/extern/images/arrowTag.png',
				center: true,
				iconPosition: 'bottom',
				show: 'both',
				backgroundColor: '#DADADA',
		...
		_createActions: function (actions){
			...
			var buttonMenu = new qx.ui.form.MenuButton(tr('Actions'), "eyeos/extern//images/arrowPlace2.png", menu);
			buttonMenu.set({
...
//			});
		...
		_populateTagToolbarPeople: function() {
			...
			if (this._context == 'All'){
				...
				var customAddButton = new qx.ui.form.Button(null, 'eyeos/extern/images/cross.png').set({
					padding : 3,
					marginRight: 10,
					allowGrowX: false,
					allowGrowY: false
		...
		_showChargingImage: function () {
			if (this._layoutItems.getBounds()){
				if (this._imageCharging == null) {
					...
					this._imageCharging = new qx.ui.basic.Image('eyeos/extern/images/loading.gif').set({
