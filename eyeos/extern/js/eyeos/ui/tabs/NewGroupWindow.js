...
qx.Class.define('eyeos.ui.tabs.NewGroupWindow', {
	...
	members: {
		...
		_arrow0: 'eyeos/extern//images/seta-0.png',
		_arrow1: 'eyeos/extern//images/seta-1.png',
		_arrow2: 'eyeos/extern//images/seta-2.png',
		_arrow3: 'eyeos/extern//images/seta-3.png',
		_arrow4: 'eyeos/extern//images/seta-4.png',
		...
		_updateBodyDescription: function () {
			...
			imageImage.setSource('eyeos/extern/images/workgroup-empty.png');
		...
		_createSearchBox: function (){
			...
			var searchClearIcon = new qx.ui.basic.Image('eyeos/extern/images/showall.png').set({
				alignY: 'middle',
				alignX: 'center',
				paddingLeft: 0,
				paddingRight: 0
		...
		_updateBodyFinal: function () {
			...
			if (this.isWellCreated()){
				image.setSource('eyeos/extern//images/48x48/actions/mail-mark-notjunk.png');
				textLabel.setValue(tr('Well done! Your workgroup has been created.'));
			} else {
				image.setSource('eyeos/extern//images/48x48/status/dialog-warning.png');
