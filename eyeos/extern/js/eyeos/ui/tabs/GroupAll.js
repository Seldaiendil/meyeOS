...
qx.Class.define('eyeos.ui.tabs.GroupAll', {
	...
	members: {
		_imagePlus: 'eyeos/extern//images/16x16/actions/list-add.png',
		_imageMinus: 'eyeos/extern//images/16x16/actions/list-remove.png',
		_imageConfigure: 'eyeos/extern//images/16x16/actions/configure.png',
		_imageAdded: 'eyeos/extern/images/22x22/actions/dialog-ok-apply.png',
		_imagePending: 'eyeos/extern//images/user-away.png',
		...
		_updateDescriptionImage: function () {
			if (this.getRole() == eyeos.ui.tabs.GroupAll.ROLE_OWNER) {
				return 'eyeos/extern//images/rate_on.png';
			} else {
				return '';
			}
		},
