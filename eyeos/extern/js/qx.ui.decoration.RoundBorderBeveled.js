...
qx.Class.define("qx.ui.decoration.RoundBorderBeveled", {
	...
	// implemented by qx.ui.decoration.Abstract
	...
	construct : function(outerColor, innerColor, innerOpacity, leftTopR, rightTopR, rightBottomR, leftBottomR, shadow) {
		...
		if (outerColor != null)
			this.setOuterColor(outerColor || 'transparent');
		if (innerColor != null)
			this.setInnerColor(innerColor || 'transparent');	

        if(shadow != null)
            this.setShadow(shadow);
		
		this.setLeftTopR(leftTopR || 0);
		this.setRightTopR(rightTopR || 0);
		this.setRightBottomR(rightBottomR || 0);
		this.setLeftBottomR(leftBottomR || 0);
	},
	...
	properties : {
		...
		*/
		...
		corners :
		{
			group: [ "leftTopR", "rightTopR", "rightBottomR", "leftBottomR" ],
			mode  : "shorthand",
			themeable : true
		},
