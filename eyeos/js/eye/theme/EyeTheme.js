...
qx.Theme.define("eye.theme.EyeTheme",
{
	title : "eyeOS Theme",
	meta :
	{
		color : eye.theme.eyetheme.Color,
		decoration : eye.theme.eyetheme.Decoration,
		font : eye.theme.eyetheme.Font,
		icon : qx.theme.icon.Oxygen,
		appearance : eye.theme.eyetheme.Appearance
	}
});
