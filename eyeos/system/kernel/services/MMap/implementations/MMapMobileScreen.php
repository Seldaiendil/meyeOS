...
class MMapMobileScreen extends Kernel implements IMMap {
	...
	public function checkRequest(MMapRequest $request) {
		return self::isMobileBrowser() && (!$request->issetGET('mobile'))
				&& (!$request->issetGET('download')) && (!$request->issetGET('downloadFile'));
	}
		...
		$body =
			...
			<html>
			  <head>
				...
				$body .= '<!-- Load jquery -->
				<script src="eyeos/extern/js/jquery/jquery-1.5.1.min.js"></script>

				<!-- Load json support -->
				<script src="eyeos/extern/js/jquery/lib/json/jquery.json-2.2.min.js"></script>
				
				<!-- Load eyeosmobile-->
				<script type="text/javascript" src="eyeos/extern/js/eyeosmobile/eyeosmobile.js"></script>
				...
				<!-- <script src="eyeos/extern/js/jquery/lib/jquerymobile/jquery.mobile-1.0a3.js"></script> -->
				
				<link rel="stylesheet" href="eyeos/extern/js/jquery/lib/jquerymobile/jquery.mobile-1.0a3.min.css" />
				<script src="eyeos/extern/js/jquery/lib/jquerymobile/jquery.mobile-1.0a3.min.js"></script>

				<link rel="icon" type="image/png" href="eyeos/extern/images/favicon.png" />
				<link rel="apple-touch-icon" href="eyeos/extern/images/touch-icon.png" />
			  </head>
			  <body>
