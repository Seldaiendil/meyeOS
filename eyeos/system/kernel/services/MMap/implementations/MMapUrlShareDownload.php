	...
	private function renderFoundFile($fileName, $fileSize, $urlName, $response, $hasPassword, $wrongPassword) {
		...
		$htmlString =
			...
			<html xmlns="http://www.w3.org/1999/xhtml">
				...
				<center>
					<div id="centerdiv">
						<img id="logo_eyeos" src="eyeos/extern/images/urlsharedownload/logo_eyeos.png" alt="logo_eyeos" /><br />
						<img id="shadow" src="eyeos/extern/images/urlsharedownload/line.png" alt="logo_eyeos" /><br />
						<div id="main">
							<div id="file_info">
								<img id="file_info_logo" alt="logo of the file" src="eyeos/extern/images/48x48/mimetypes/image-x-generic.png" />
		...
		if ($wrongPassword) {
			...
			$htmlString.=
						...
						<div id="download" onClick="javascript:document.getElementById(\'downForm\').submit()">
							<span>Download</span>
							<img src="eyeos/extern/images/urlsharedownload/arrow.png" alt="download" />
						</div>
						<div style="clear: both"></div>
					</div>
				</div>
			 ...
			 <html xmlns="http://www.w3.org/1999/xhtml">
				...
				<center>
					<div id="centerdiv">
						...
						<div id="main">
							<div id="file_info">
								<img id="file_info_logo" alt="logo of the file" src="eyeos/extern/images/48x48/mimetypes/unknown.png" />
