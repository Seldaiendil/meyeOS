...
<table style="width:600px;">
        <?php
            ...
            /**
             * @todo Revise this requeriment! 5.3.0 is needed to prevent T_PAAMAYIM_NEKUDOTAYIM parsing error.
             */
...
//            }
            ...
            */
            ...
            /**
             * Now check permisions on writeable folders
             * The base is needed to add settings-local.php
             */
            $base = realpath('..') ;
            $folder = $base . '/';
          echo '<tr><td style="padding-right:10px;" align="right">Writeable permisions to basedir ' . $folder . ' :</td>';
            if(is_writable($folder)) {
                echo '<td class="textok" style="padding-left:10px;">Yes <img style="margin-left:10px;" img src="ok.png" /></td></tr>';
            } else {
                echo '<td class="textno" style="padding-left:10px;">No  <img style="margin-left:10px;" img src="no.png" /></td></tr>';
            }

            $relative = 'eyeos/system/conf/libs/log4php/logs';
          echo '<tr><td style="padding-right:10px;" align="right">Is Writeable <br>' . $relative . ' ?</td>';
          $folder = $base . '/' . $relative;
            ...
            $relative = 'eyeos/system/conf/libs/idGen';
          echo '<tr><td style="padding-right:10px;" align="right">Is Writeable <br>' . $relative . ' ?</td>';
          $folder = $base . '/' . $relative;
            if(is_writable($folder)) {
                echo '<td class="textok" style="padding-left:10px;">Yes <img style="margin-left:10px;" img src="ok.png" /></td></tr>';
            ...
            $relative = 'eyeos/tmp';
          echo '<tr><td style="padding-right:10px;" align="right">Is Writeable ' . $relative . ' ?</td>';
          $folder = $base . '/' . $relative;
            if(is_writable($folder)) {
                echo '<td class="textok" style="padding-left:10px;">Yes <img style="margin-left:10px;" img src="ok.png" /></td></tr>';
            } else {
          ...
          $relative = 'eyeos/system/kernel/services/MMap/cache';
          echo '<tr><td style="padding-right:10px;" align="right">Is Writeable <br>' . $relative . ' ?</td>';
          $folder = $base . '/' . $relative;
            if(is_writable($folder)) {
                echo '<td class="textok" style="padding-left:10px;">Yes <img style="margin-left:10px;" img src="ok.png" /></td></tr>';
